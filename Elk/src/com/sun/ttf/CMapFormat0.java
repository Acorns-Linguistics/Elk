...
public class CMapFormat0 extends CMap {
  ...
  */
  ...
  {  super((short) 0, language);
     ...
     */
  public short getLength() {  return (short) 262; }
  ...
  {   if (src  < 0 || src > 255) { return (char) 0;  }
  ...
  {  for (int i = 0; i < glyphIndex.length; i++)
     {  if ((glyphIndex[i] & 0xff) == glyphID) { return (char) i; }
     }
     return (char) 0;
  }
  ...
  {  if (src<0 || src>255) return;
     glyphIndex[src] = (byte)glyph;
  }
    
  /**
   * Get the whole map
   */
  protected byte[] getMap() {  return glyphIndex;  }
