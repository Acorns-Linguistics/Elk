...
public class PostTable extends TrueTypeTable
{
     ...
     */
    public String getGlyphName(char c) { return nameMap.getCharName(c); }
    ...
    {   int size = 32;
        if (nameMap != null) {  size += nameMap.getLength(); }
        return size;
    }
     ...
     */
    public int getItalicAngle() {  return this.italicAngle; }
     ...
     */
    public short getUnderlinePosition() { return this.underlinePosition; }
     ...
     */
    public short getUnderlineThickness() { return this.underlineThickness; }
     ...
     */
    public short getIsFixedPitch() { return this.isFixedPitch; }
     ...
     */
    public int getMinMemType42() { return this.minMemType42; }
     ...
     */
    public int getMaxMemType42() { return this.maxMemType42; }
     ...
     */
    public int getMinMemType1() { return this.minMemType1; }
     ...
     *
     */
    public int getMaxMemType1() { return this.maxMemType1; }
    ...
    /** An empty post map class that is overridden by child classes
     *  It maps character names to unicode character indices and visa versa
     *  for standard keyboard characters
     */
    class PostMap
    {   /** map a name to a character index */
        short getCharIndex(String charName) { return (short) 0; }
        
        /** name a character index to a name */
        String getCharName(char charIndex) { return null; }
        
        /** get the length of the data in this map */
        int getLength() { return 0; }
        
        /** get the data in this map as a ByteBuffer */
        ByteBuffer getData() { return ByteBuffer.allocate(0); }
        
        /** set the data in this map from a ByteBuffer */
        void setData(ByteBuffer data) { return; }
    }
...
/* 8 */     "percent", "ampersand", "quotesingle", "parenleft", "parenright"
               , "asterisk", "plus", "comma",
/* 16 */    "hyphen", "period", "slash", "zero", "one", "two", "three", "four",
/* 24 */    "five", "six", "seven", "eight", "nine", "colon", "semicolon"
               , "less",
/* 32 */    "equal", "greater", "question", "at", "A", "B", "C", "D",
/* 40 */    "E", "F", "G", "H", "I", "J", "K", "L",
/* 48 */    "M", "N", "O", "P", "Q", "R", "S", "T", 
/* 56 */    "U", "V", "W", "X", "Y", "Z", "bracketleft", "ackslash",
/* 64 */    "bracketright", "asciicircum", "underscore", "grave", "a", "b", "c"
               , "d",
/* 72 */    "e", "f", "g", "h", "i", "j", "k", "l", 
/* 80 */    "m", "n", "o", "p", "q", "r", "s", "t",
/* 88 */    "u", "v", "w", "x", "y", "z", "braceleft", "bar",
/* 96 */    "braceright", "asciitilde", "Adieresis", "Aring", "Ccedilla"
               , "Eacute", "Ntilde", "Odieresis",
/* 104 */   "Udieresis", "aacute", "agrave", "acircumflex", "adieresis"
               , "atilde", "aring", "ccedilla",
/* 112 */   "eacute", "egrave", "ecircumflex", "edieresis", "iacute", "igrave"
               , "icircumflex", "idieresis",
/* 120 */   "ntilde", "oacute", "ograve", "ocircumflex", "odieresis", "otilde"
               , "uacute", "ugrave",
/* 128 */   "ucircumflex", "udieresis", "dagger", "degree", "cent", "sterling"
               , "section", "bullet",
/* 136 */   "paragraph", "germandbls", "registered", "copyright", "trademark"
               , "acute", "dieresis", "notequal",
/* 144 */   "AE", "Oslash", "infinity", "plusminus", "lessequal"
               , "greaterequal", "yen", "mu",
/* 152 */   "partialdiff", "summation", "product", "pi", "integral"
               , "ordfeminine", "ordmasculine", "Omega",
/* 160 */   "ae", "oslash", "questiondown", "exclamdown", "logicalnot"
               , "radical", "florin", "approxequal",
/* 168 */   "Delta", "guillemotleft", "guillemotright", "ellipsis"
               , "nonbreakingspace", "Agrave", "Atilde", "Otilde",
/* 176 */   "OE", "oe", "endash", "emdash", "quotedblleft", "quotedblright"
               , "quoteleft", "quoteright",
/* 184 */   "divide", "lozenge", "ydieresis", "Ydieresis", "fraction"
               , "currency", "guilsinglleft", "guilsinglright",
/* 192 */   "fi", "fl", "daggerdbl", "periodcentered", "quotesinglbase"
               , "quotedblbase", "perthousand", "Acircumflex",
/* 200 */   "Ecircumflex", "Aacute", "Edieresis", "Egrave", "Iacute"
               , "Icircumflex", "Idieresis", "Igrave",
/* 208 */   "Oacute", "Ocircumflex", "apple", "Ograve", "Uacute", "Ucircumflex"
               , "Ugrave", "dotlessi",
/* 216 */   "circumflex", "tilde", "macron", "breve", "dotaccent", "ring"
               , "cedilla", "hungarumlaut",
/* 224 */   "ogonek", "caron", "Lslash", "lslash", "Scaron", "scaron", "Zcaron"
               , "zcaron",
/* 232 */   "brokenbar", "Eth", "eth", "Yacute", "yacute", "Thorn", "thorn"
               , "minus",
/* 240 */   "multiply", "onesuperior", "twosuperior", "threesuperior", "onehalf"
               , "onequarter", "threequarters", "franc",
/* 248 */   "Gbreve", "gbreve", "Idotaccent", "Scedilla", "scedilla", "Cacute"
               , "cacute", "Ccaron",
/* 256 */   "ccaron", "dcroat"
        };
        
        /** map a name to a character index */
        protected @Override short getCharIndex(String charName)
        {  for (int i = 0; i < stdNames.length; i++)
           {  if (charName.equals(stdNames[i])) { return (short) i; }
           }
           return (short) 0;
        }
        
        /** name a character index to a name */
        protected @Override String getCharName(char charIndex)
        {  return stdNames[charIndex];  }
        
        /** get the length of the data in this map */
        protected @Override int getLength() { return 0; }
        
        /** get the data in this map as a ByteBuffer */
        protected @Override ByteBuffer getData()
        {  return ByteBuffer.allocate(0); }
        
        /** set the data in this map from a ByteBuffer */
        protected @Override void setData(ByteBuffer data) { return; }
    }
    ...
    class PostMapFormat2 extends PostMapFormat0 
    {
        ...
        protected @Override void setData(ByteBuffer data)
    ...
    }           // End of PostMapFormat2 class
}               // End of PostTable class
